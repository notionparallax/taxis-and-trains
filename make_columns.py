...
def demo_route(index, description):
    ...
    print("Transit")
    print("Transit total time taken", d['Public Transport']['routes'][0]['legs'][0]['duration']['text'])
    print("Transit total distance travelled", d['Public Transport']['routes'][0]['legs'][0]['distance']['text'])
...
demo_route(0, "Pitt St to Underwood St")    
